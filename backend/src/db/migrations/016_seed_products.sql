-- Migration 016: Seed Products (Popular Russian Products)
-- Date: 2026-01-07
-- Description: Базовые популярные продукты для старта (остальное через OpenFoodFacts API)
-- КБЖУ на 100г продукта
-- NOTE: Uses ON CONFLICT DO NOTHING to prevent duplicates on re-run
