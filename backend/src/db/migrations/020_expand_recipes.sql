...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Каша гречневая с бананом', 'breakfast', 15, 1, 'simple', 'Отварить гречку, добавить банан.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Овсянка с малиной', 'breakfast', 10, 1, 'simple', 'Залить овсянку, добавить малину.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Яичница с сыром', 'breakfast', 10, 1, 'simple', 'Обжарить яйца, добавить сыр.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с виноградом', 'breakfast', 5, 1, 'simple', 'Смешать творог с виноградом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Овсянка с изюмом', 'breakfast', 10, 1, 'simple', 'Залить овсянку, добавить изюм.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Каша рисовая молочная', 'breakfast', 20, 1, 'simple', 'Отварить рис в молоке.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Бутерброд с яйцом', 'breakfast', 10, 1, 'simple', 'Поджарить хлеб, положить яйцо.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Йогурт с бананом', 'breakfast', 5, 1, 'simple', 'Смешать йогурт с бананом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Омлет с луком', 'breakfast', 12, 1, 'simple', 'Обжарить лук, залить яйцами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Каша овсяная с финиками', 'breakfast', 10, 1, 'simple', 'Залить овсянку, добавить финики.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рис с индейкой', 'lunch', 30, 1, 'simple', 'Отварить рис, обжарить индейку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка с телятиной', 'lunch', 35, 1, 'simple', 'Отварить гречку, обжарить телятину.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Паста с креветками', 'lunch', 20, 1, 'simple', 'Отварить пасту, обжарить креветки.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Булгур с курицей', 'lunch', 25, 1, 'simple', 'Отварить булгур, обжарить курицу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Киноа с лососем', 'lunch', 30, 1, 'medium', 'Отварить киноа, запечь лосось.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рис с кальмарами', 'lunch', 20, 1, 'simple', 'Отварить рис, обжарить кальмары.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка с говяжьим фаршем', 'lunch', 25, 1, 'simple', 'Отварить гречку, обжарить фарш.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рис бурый с курицей', 'lunch', 35, 1, 'simple', 'Отварить рис, обжарить курицу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Паста с курицей', 'lunch', 25, 1, 'simple', 'Отварить пасту, обжарить курицу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Чечевичный суп', 'lunch', 40, 2, 'medium', 'Сварить чечевицу с овощами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рис с мидиями', 'lunch', 25, 1, 'medium', 'Отварить рис, обжарить мидии.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Перловка с говядиной', 'lunch', 50, 1, 'medium', 'Отварить перловку, тушить говядину.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка с куриным фаршем', 'lunch', 25, 1, 'simple', 'Отварить гречку, обжарить фарш.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рис с горбушей', 'lunch', 30, 1, 'simple', 'Отварить рис, запечь горбушу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Булгур с говядиной', 'lunch', 35, 1, 'simple', 'Отварить булгур, обжарить говядину.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат с курицей и авокадо', 'dinner', 15, 1, 'simple', 'Нарезать курицу и авокадо, смешать с салатом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Лосось с брокколи', 'dinner', 25, 1, 'simple', 'Запечь лосось с брокколи.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Омлет с овощами', 'dinner', 12, 1, 'simple', 'Обжарить овощи, залить яйцами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Минтай с овощами', 'dinner', 25, 1, 'simple', 'Запечь минтай с овощами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат с креветками', 'dinner', 15, 1, 'simple', 'Обжарить креветки, смешать с салатом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Индейка запеченная', 'dinner', 35, 1, 'simple', 'Запечь индейку с овощами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Треска с овощами гриль', 'dinner', 25, 1, 'simple', 'Обжарить треску, запечь овощи.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Котлеты куриные паровые', 'dinner', 30, 1, 'simple', 'Приготовить котлеты на пару.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат из капусты с морковью', 'dinner', 10, 1, 'simple', 'Нашинковать капусту и морковь.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Курица с кабачками', 'dinner', 30, 1, 'simple', 'Обжарить курицу с кабачками.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Яблоко с миндалем', 'snack', 2, 1, 'simple', 'Нарезать яблоко, добавить миндаль.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с медом', 'snack', 5, 1, 'simple', 'Смешать творог с медом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кефир с бананом', 'snack', 5, 1, 'simple', 'Взбить кефир с бананом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Орехи с курагой', 'snack', 0, 1, 'simple', 'Смешать орехи с курагой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Йогурт с клубникой', 'snack', 5, 1, 'simple', 'Смешать йогурт с клубникой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Груша с творогом', 'snack', 5, 1, 'simple', 'Нарезать грушу, добавить творог.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Смузи с малиной', 'snack', 5, 1, 'simple', 'Взбить малину с йогуртом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Персик с творогом', 'snack', 5, 1, 'simple', 'Нарезать персик, добавить творог.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Банан с кефиром', 'snack', 5, 1, 'simple', 'Взбить банан с кефиром.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Финики с орехами', 'snack', 0, 1, 'simple', 'Смешать финики с орехами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Апельсин с йогуртом', 'snack', 5, 1, 'simple', 'Нарезать апельсин, добавить йогурт.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Черника с творогом', 'snack', 5, 1, 'simple', 'Смешать чернику с творогом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Слива с орехами', 'snack', 2, 1, 'simple', 'Нарезать сливы, добавить орехи.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Молоко с бананом', 'snack', 5, 1, 'simple', 'Взбить молоко с бананом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Абрикос с йогуртом', 'snack', 5, 1, 'simple', 'Нарезать абрикосы, добавить йогурт.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Ещё завтраки
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Каша пшенная с молоком', 'breakfast', 25, 1, 'simple', 'Отварить пшено в молоке.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с курагой', 'breakfast', 5, 1, 'simple', 'Смешать творог с курагой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Овсянка с абрикосом', 'breakfast', 10, 1, 'simple', 'Залить овсянку, добавить абрикос.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Яичница с кабачком', 'breakfast', 12, 1, 'simple', 'Обжарить кабачок, добавить яйца.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка с маслом', 'breakfast', 20, 1, 'simple', 'Отварить гречку, добавить масло.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с черносливом', 'breakfast', 5, 1, 'simple', 'Смешать творог с черносливом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Омлет с морковью', 'breakfast', 12, 1, 'simple', 'Обжарить морковь, залить яйцами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Каша овсяная с яблоком', 'breakfast', 10, 1, 'simple', 'Залить овсянку, добавить яблоко.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Бутерброд с сыром', 'breakfast', 5, 1, 'simple', 'Положить сыр на хлеб.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Йогурт с черникой', 'breakfast', 5, 1, 'simple', 'Смешать йогурт с черникой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Каша рисовая с изюмом', 'breakfast', 25, 1, 'simple', 'Отварить рис, добавить изюм.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с малиной', 'breakfast', 5, 1, 'simple', 'Смешать творог с малиной.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Омлет с болгарским перцем', 'breakfast', 12, 1, 'simple', 'Обжарить перец, залить яйцами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Овсянка с кешью', 'breakfast', 10, 1, 'simple', 'Залить овсянку, добавить кешью.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Каша гречневая с яйцом', 'breakfast', 20, 1, 'simple', 'Отварить гречку, добавить яйцо.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Ещё обеды
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Куриный суп', 'lunch', 40, 2, 'simple', 'Сварить бульон с овощами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Тунец с рисом', 'lunch', 25, 1, 'simple', 'Отварить рис, добавить тунец.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Свинина с гречкой', 'lunch', 35, 1, 'simple', 'Обжарить свинину, отварить гречку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Баранина с рисом', 'lunch', 45, 1, 'medium', 'Тушить баранину, отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Куриное бедро с овощами', 'lunch', 40, 1, 'simple', 'Запечь бедро с овощами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Лосось с рисом', 'lunch', 30, 1, 'simple', 'Запечь лосось, отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка с овощами', 'lunch', 25, 1, 'simple', 'Отварить гречку с овощами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Индейка с рисом', 'lunch', 30, 1, 'simple', 'Обжарить индейку, отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Треска с гречкой', 'lunch', 30, 1, 'simple', 'Запечь треску, отварить гречку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Говядина с булгуром', 'lunch', 40, 1, 'medium', 'Тушить говядину, отварить булгур.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Куриный фарш с рисом', 'lunch', 25, 1, 'simple', 'Обжарить фарш, отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Минтай с гречкой', 'lunch', 30, 1, 'simple', 'Запечь минтай, отварить гречку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Телятина с рисом бурым', 'lunch', 40, 1, 'simple', 'Тушить телятину, отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Креветки с булгуром', 'lunch', 20, 1, 'simple', 'Обжарить креветки, отварить булгур.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Горбуша с гречкой', 'lunch', 30, 1, 'simple', 'Запечь горбушу, отварить гречку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Скумбрия с рисом', 'lunch', 35, 1, 'simple', 'Запечь скумбрию, отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кальмары с рисом', 'lunch', 20, 1, 'simple', 'Обжарить кальмары, отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Мидии с пастой', 'lunch', 25, 1, 'medium', 'Обжарить мидии, отварить пасту.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Чечевица с индейкой', 'lunch', 35, 1, 'medium', 'Отварить чечевицу с индейкой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Киноа с курицей', 'lunch', 30, 1, 'simple', 'Отварить киноа, обжарить курицу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Перловка с курицей', 'lunch', 50, 1, 'medium', 'Отварить перловку с курицей.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рис с тофу', 'lunch', 25, 1, 'simple', 'Отварить рис, обжарить тофу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка с тофу', 'lunch', 25, 1, 'simple', 'Отварить гречку, обжарить тофу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Фасолевый суп', 'lunch', 45, 2, 'medium', 'Сварить суп с фасолью.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гороховый суп', 'lunch', 50, 2, 'medium', 'Сварить суп с горохом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Нут с курицей', 'lunch', 40, 1, 'medium', 'Отварить нут, обжарить курицу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Ещё ужины
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат из огурцов и помидоров', 'dinner', 10, 1, 'simple', 'Нарезать овощи, заправить.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Омлет с тофу', 'dinner', 15, 1, 'simple', 'Обжарить тофу, залить яйцами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Курица с брокколи', 'dinner', 25, 1, 'simple', 'Обжарить курицу с брокколи.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рыба с цветной капустой', 'dinner', 30, 1, 'simple', 'Запечь рыбу с капустой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат с яйцом и огурцом', 'dinner', 15, 1, 'simple', 'Сварить яйца, нарезать огурцы.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Индейка с баклажанами', 'dinner', 30, 1, 'simple', 'Обжарить индейку с баклажанами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Лосось со шпинатом', 'dinner', 25, 1, 'simple', 'Запечь лосось, обжарить шпинат.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат с моцареллой', 'dinner', 10, 1, 'simple', 'Нарезать моцареллу с помидорами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Тыквенная каша', 'dinner', 30, 1, 'simple', 'Отварить тыкву с рисом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Запеканка из кабачков', 'dinner', 40, 2, 'medium', 'Запечь кабачки с яйцом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Курица с тыквой', 'dinner', 35, 1, 'simple', 'Запечь курицу с тыквой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Минтай на пару', 'dinner', 20, 1, 'simple', 'Приготовить минтай на пару.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат с авокадо', 'dinner', 10, 1, 'simple', 'Нарезать авокадо с овощами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Тофу со шпинатом', 'dinner', 15, 1, 'simple', 'Обжарить тофу со шпинатом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Котлеты из индейки', 'dinner', 30, 1, 'simple', 'Сформировать и обжарить котлеты.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Салат из капусты', 'dinner', 10, 1, 'simple', 'Нашинковать капусту.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Горбуша запеченная', 'dinner', 30, 1, 'simple', 'Запечь горбушу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Яйца с овощами', 'dinner', 15, 1, 'simple', 'Обжарить овощи с яйцами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Куриные котлеты паровые', 'dinner', 25, 1, 'simple', 'Приготовить котлеты на пару.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
INSERT INTO recipe_items (recipe_id, product_id, amount_grams) SELECT recipe.id, products.id, amount FROM recipe, (VALUES ('Куриный фарш', 180), ('Лук репчатый', 30)) AS items(product_name, amount) JOIN products ON products.name = items.product_name
ON CONFLICT (recipe_id, product_id) DO NOTHING;

WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Треска запеченная', 'dinner', 25, 1, 'simple', 'Запечь треску.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Ещё перекусы
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кефир с ягодами', 'snack', 5, 1, 'simple', 'Взбить кефир с ягодами.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с грушей', 'snack', 5, 1, 'simple', 'Нарезать грушу, добавить творог.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Йогурт с персиком', 'snack', 5, 1, 'simple', 'Нарезать персик, добавить йогурт.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Миндаль с черносливом', 'snack', 0, 1, 'simple', 'Смешать миндаль с черносливом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Ряженка с бананом', 'snack', 5, 1, 'simple', 'Взбить ряженку с бананом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Грецкие орехи с медом', 'snack', 2, 1, 'simple', 'Полить орехи медом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Киви с йогуртом', 'snack', 5, 1, 'simple', 'Нарезать киви, добавить йогурт.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с виноградом', 'snack', 5, 1, 'simple', 'Смешать творог с виноградом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Фундук с курагой', 'snack', 0, 1, 'simple', 'Смешать фундук с курагой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Молоко с клубникой', 'snack', 5, 1, 'simple', 'Взбить молоко с клубникой.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Арахис с изюмом', 'snack', 0, 1, 'simple', 'Смешать арахис с изюмом.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Йогурт с грейпфрутом', 'snack', 5, 1, 'simple', 'Нарезать грейпфрут, добавить йогурт.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог с яблоком', 'snack', 5, 1, 'simple', 'Нарезать яблоко, добавить творог.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кешью с финиками', 'snack', 0, 1, 'simple', 'Смешать кешью с финиками.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Смузи с бананом и клубникой', 'snack', 5, 1, 'simple', 'Взбить банан с клубникой и молоком.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Больше завтраков
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рисовая каша на воде', 'breakfast', 20, 1, 'simple', 'Отварить рис в воде.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка на воде', 'breakfast', 20, 1, 'simple', 'Отварить гречку в воде.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Овсянка на воде', 'breakfast', 10, 1, 'simple', 'Залить овсянку кипятком.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Вареные яйца', 'breakfast', 10, 1, 'simple', 'Сварить яйца вкрутую.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Творог обезжиренный', 'breakfast', 2, 1, 'simple', 'Выложить творог в миску.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кефир на завтрак', 'breakfast', 2, 1, 'simple', 'Налить кефир в стакан.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Йогурт натуральный', 'breakfast', 2, 1, 'simple', 'Вылить йогурт в миску.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Булгур на воде', 'breakfast', 15, 1, 'simple', 'Залить булгур кипятком.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Перловка на воде', 'breakfast', 40, 1, 'simple', 'Отварить перловку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Пшенка на воде', 'breakfast', 20, 1, 'simple', 'Отварить пшено.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Больше обедов
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Рис отварной', 'lunch', 20, 1, 'simple', 'Отварить рис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Гречка отварная', 'lunch', 20, 1, 'simple', 'Отварить гречку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Макароны отварные', 'lunch', 15, 1, 'simple', 'Отварить макароны.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Куриная грудка отварная', 'lunch', 25, 1, 'simple', 'Отварить куриную грудку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Индейка отварная', 'lunch', 25, 1, 'simple', 'Отварить индейку.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Говядина отварная', 'lunch', 60, 1, 'medium', 'Отварить говядину.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Телятина отварная', 'lunch', 50, 1, 'medium', 'Отварить телятину.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Треска отварная', 'lunch', 20, 1, 'simple', 'Отварить треску.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Минтай отварной', 'lunch', 20, 1, 'simple', 'Отварить минтай.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Горбуша отварная', 'lunch', 20, 1, 'simple', 'Отварить горбушу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Креветки отварные', 'lunch', 10, 1, 'simple', 'Отварить креветки.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кальмары отварные', 'lunch', 5, 1, 'simple', 'Отварить кальмары 2 минуты.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Чечевица отварная', 'lunch', 25, 1, 'simple', 'Отварить чечевицу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Нут отварной', 'lunch', 60, 1, 'medium', 'Отварить нут.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Киноа отварная', 'lunch', 15, 1, 'simple', 'Отварить киноа.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Больше ужинов
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Брокколи на пару', 'dinner', 15, 1, 'simple', 'Приготовить брокколи на пару.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Цветная капуста на пару', 'dinner', 15, 1, 'simple', 'Приготовить капусту на пару.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кабачки на пару', 'dinner', 15, 1, 'simple', 'Приготовить кабачки на пару.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Тыква запеченная', 'dinner', 30, 1, 'simple', 'Запечь тыкву.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Морковь отварная', 'dinner', 20, 1, 'simple', 'Отварить морковь.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Свекла отварная', 'dinner', 60, 1, 'simple', 'Отварить свеклу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Шпинат тушеный', 'dinner', 10, 1, 'simple', 'Потушить шпинат.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Баклажаны запеченные', 'dinner', 30, 1, 'simple', 'Запечь баклажаны.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Болгарский перец запеченный', 'dinner', 25, 1, 'simple', 'Запечь перец.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Капуста тушеная', 'dinner', 30, 1, 'simple', 'Потушить капусту.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
-- Больше перекусов
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Яблоко свежее', 'snack', 0, 1, 'simple', 'Помыть яблоко.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Банан свежий', 'snack', 0, 1, 'simple', 'Очистить банан.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Апельсин свежий', 'snack', 0, 1, 'simple', 'Очистить апельсин.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Грейпфрут свежий', 'snack', 0, 1, 'simple', 'Очистить грейпфрут.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Груша свежая', 'snack', 0, 1, 'simple', 'Помыть грушу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Киви свежий', 'snack', 0, 1, 'simple', 'Очистить киви.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Персик свежий', 'snack', 0, 1, 'simple', 'Помыть персик.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Абрикосы свежие', 'snack', 0, 1, 'simple', 'Помыть абрикосы.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Слива свежая', 'snack', 0, 1, 'simple', 'Помыть сливы.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Клубника свежая', 'snack', 0, 1, 'simple', 'Помыть клубнику.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Черника свежая', 'snack', 0, 1, 'simple', 'Промыть чернику.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Малина свежая', 'snack', 0, 1, 'simple', 'Промыть малину.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Виноград свежий', 'snack', 0, 1, 'simple', 'Помыть виноград.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Арбуз свежий', 'snack', 0, 1, 'simple', 'Нарезать арбуз.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Дыня свежая', 'snack', 0, 1, 'simple', 'Нарезать дыню.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Миндаль горсть', 'snack', 0, 1, 'simple', 'Отмерить миндаль.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Грецкие орехи горсть', 'snack', 0, 1, 'simple', 'Отмерить орехи.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Кешью горсть', 'snack', 0, 1, 'simple', 'Отмерить кешью.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Фундук горсть', 'snack', 0, 1, 'simple', 'Отмерить фундук.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Арахис горсть', 'snack', 0, 1, 'simple', 'Отмерить арахис.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Курага горсть', 'snack', 0, 1, 'simple', 'Отмерить курагу.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Чернослив горсть', 'snack', 0, 1, 'simple', 'Отмерить чернослив.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Финики горсть', 'snack', 0, 1, 'simple', 'Отмерить финики.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Изюм горсть', 'snack', 0, 1, 'simple', 'Отмерить изюм.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Огурцы свежие', 'snack', 0, 1, 'simple', 'Помыть огурцы.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Помидоры свежие', 'snack', 0, 1, 'simple', 'Помыть помидоры.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Морковь свежая', 'snack', 0, 1, 'simple', 'Помыть морковь.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
...
WITH recipe AS (INSERT INTO recipes (name, meal_type, cooking_time, servings, complexity, instructions) VALUES ('Авокадо свежее', 'snack', 0, 1, 'simple', 'Разрезать авокадо.') ON CONFLICT (name) DO UPDATE SET name = EXCLUDED.name RETURNING id)
